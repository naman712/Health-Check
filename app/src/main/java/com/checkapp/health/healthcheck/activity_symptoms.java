...
public class activity_symptoms extends AppCompatActivity {
    ...
    String diarrhoea[] = {"Stomach Ache","Nausea","Sudden Weight Loss"};
    String malaria[] = {"Sweating","Muscle And Body Pain","Fever"};
    String typhoid[] = {"Vomiting","Weakness/Fatigue","Abdominal Pain","Muscle Pain","Dry Cough","Diarrhoea/Constipation"};
    String diabetes[] = {"Frequent Urination","Hunger","Thirsty Than Usual","Sudden Weight Loss","Blurred Vision","Skin Itching"};
    String blood_pressure[] = {"Headaches","Blurred Vision","Chest Pain","Shortness in Breath","Dizziness","Nausea"};
