package com.checkapp.health.healthcheck;
...
public class activity_disease extends AppCompatActivity {
    ...
    int i=0;
        ...
        if (max == c[0]) {
            im[i].setImageDrawable(getResources().getDrawable(R.drawable.d1,null));
        ...
        if (max == c[1]) {
            im[i].setImageDrawable(getResources().getDrawable(R.drawable.d2,null));
        ...
        if (max == c[2]) {
            im[i].setImageDrawable(getResources().getDrawable(R.drawable.d3,null));
        ...
        if (max == c[3]) {
            im[i].setImageDrawable(getResources().getDrawable(R.drawable.d4,null));
        ...
        if (max == c[4]) {
            im[i].setImageDrawable(getResources().getDrawable(R.drawable.d5,null));
        ...
        if (max == c[5]) {
            im[i].setImageDrawable(getResources().getDrawable(R.drawable.d6,null));
